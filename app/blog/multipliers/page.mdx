...
+ School
	...
	+ (More general) join a group that puts you in an position where you need to learn things you weren't capable of. 
		...
		+ The *[Pmarca Blog Archives](https://a16z.com/wp-content/uploads/2021/08/The-pmarca-Blog-Archives.pdf)* by Marc Andreessen touches on this topic. Marc Andreessen's advice can be very direct, though the takeaway is his approach to identifying what engagements to commit to in school.  
...
+ Research
	...
	+ Pursue goal-driven research as opposed to idea-drive research (["An Opinionated Guide to ML Research"](http://joschu.net/blog/opinionated-guide-ml-research.html) by John Schulman)
+ Finance
